...
.no-video-inner {
  ...
  .img1 {
    ...
    margin: auto;
    margin-bottom: 6px;
    background-image: url($SCSSPROJECTPATH+"/img/novideo1.png");
  }
  .img2 {
    background-image: url($SCSSPROJECTPATH+"/img/novideo2.png");
  }
  .img3 {
    background-image: url($SCSSPROJECTPATH+"/img/novideo3.png");
  }
  .img4 {
    background-image: url($SCSSPROJECTPATH+"/img/novideo4.png");
  }
  .img5 {
    background-image: url($SCSSPROJECTPATH+"/img/novideo5.png");
  }
}
</style>