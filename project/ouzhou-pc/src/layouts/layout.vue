...
<template>
    <div class="page-main full-height" :style="page_style" id="parent">
        ...
        <Vue3DraggableResizable v-model:x="BetData.bet_box_draggable.x" v-model:y="BetData.bet_box_draggable.y"
            v-model:h="BetData.bet_box_draggable.height" v-model:active="BetData.bet_box_draggable.isActive"
            :draggable="true" :parent="true" :resizable="false" parent="#parent" v-if="BetData.bet_box_draggable.show">
