...
-->
<template>
  <span v-if="icon_styles != -1" class="q-icon icon c-icon sport-img" :class="{ img36: !is_esports }"
...
const icon_styles = computed(() => {
  ...
  return ((parseInt(number * size * 100) / 100))- number
}) 
</script>

<style lang="scss" scoped>
.img36 {
  background-image: url('../../../../../../../../src/assets/images/icon_sports.png');
}
