  ...
  <div class="record-table col" :class="{'no-record-data': early_settlement_data.length == 0}">
    ...
    <div class="data-table column">
      ...
      <div class="row head">
        ...
        <!--列-->
        <div class="ceil">
          {{ $t('bet_record.betting_details')}}
          <!-- 投注详情 -->
        </div>
        <!--列-->
        <div class="ceil">
          {{ $t('bet_record.betting_play')}}
          <!-- 投注玩法 -->
        </div>
        <!--列-->
        <div class="ceil">
          {{ $t('bet_record.options')}}
          <!-- 选项 -->
        </div>
        <!--列-->
        <div class="ceil">
                      ...
                      <div class="item-result">
                        ...
                        <template v-if="['0','1'].includes(data.orderStatus) && data.seriesType != '1'">
                          ...
                          <template v-if="[3, 4].includes(item.betStatus)">
                            ...
                            <span v-else class="bet-result lose-color">{{ $t("bet.invalid")}}</span>
                          </template>
                          <!-- 其他 -->
                          <span
