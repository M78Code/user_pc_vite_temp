...
<template>
  <div class="calendar-wrap" @click.stop>
    ...
    <div class="item-wrap row">
      <!--周日-->
      <div class="item border1">{{ $root.$t('time.time_date_week[0]') }}<div class="bg"></div>
      </div>
      <!--周一-->
      ...
      <!--周六-->
      <div class="item border1">{{ $root.$t('time.time_date_week[6]') }}<div class="bg bg2"></div>
      </div>
      <!--日期列表-->
...
const months = ref([
  {
    label: $t('time.month_1'),
    value: 1
  },
  {
    label: $t('time.month_2'),
    value: 2
  },
  {
    label: $t('time.month_3'),
    value: 3
  },
  {
    label: $t('time.month_4'),
    value: 4
  },
  {
    label: $t('time.month_5'),
    value: 5
  },
  {
    label: $t('time.month_6'),
    value: 6
  },
  {
    label: $t('time.month_7'),
    value: 7
  },
  {
    label: $t('time.month_8'),
    value: 8
  },
  {
    label: $t('time.month_9'),
    value: 9
  },
  {
    label: $t('time.month_10'),
    value: 10
  },
  {
    label: $t('time.month_11'),
    value: 11
  },
  {
    label: $t('time.month_12'),
    value: 12
  },
])
