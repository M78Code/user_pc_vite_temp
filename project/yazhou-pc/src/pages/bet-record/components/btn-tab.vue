<template>
  ...
  <div class="tab-wrap relative-position">
    ...
    <div class="btn-wrap">
      ...
      >
        {{ i18n.t("bet_record.outstanding_notes") }}
      </div>
      <!-- 已结算注单按钮 -->
      <div
        class="btn"
      ...
      >
        {{ i18n.t("bet_record.settled_note") }}
      </div>
      <!-- 预约注单按钮 -->
      <div
        class="btn"
