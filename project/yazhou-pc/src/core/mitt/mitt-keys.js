...
// // 版本号检查状态通知
export const REQUEST_USER_BANNER = "REQUEST_USER_BANNER";
// // 重新计算投注框高度
export const TOGGLE_HANDLE = "TOGGLE_HANDLE";
export const EMIT_LIST_ON_SCROLL = "EMIT_LIST_ON_SCROLL";
export const RIGHT_DETAILS_ON_SCROLL = "RIGHT_DETAILS_ON_SCROLL";
