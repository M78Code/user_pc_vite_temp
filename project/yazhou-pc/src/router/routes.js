...
const routes = [
    // 主框架 @Amor 2020-01-14 22:12:45
    {
      ...
      component: defineAsyncComponent(() => import(`src/project/yabo/layouts/main_layout.vue`)),
      component: () =>
      import( /* webpackChunkName: "details" */ ""),
      children: [
        // 首页 @Amor 2020-01-14 22:12:45
        {
          path: "/home",
          name: "home",
          component: defineAsyncComponent(() => import(`src/project/yabo/router/components/match_list.vue`)),
          meta: {
            keepAlive: true // 需要缓存
          },
        },
