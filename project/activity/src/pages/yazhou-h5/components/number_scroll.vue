...
.number-scroll {
  ...
  &:after {
    ...
    box-shadow: 0 0.03rem 0.15rem #000 inset, 0 -0.03rem 0.15rem #000 inset;
  }
  ...
  .col-item {
    ...
    &:before {
      ...
      top: 0;
      height: 100%;
      background-image: linear-gradient(180deg, #282623 0%, #FFFFFF 51%, #282623 100%);
    }
  ...
  // }
    .row-item-1 {
      background-image: var(--q-color-com-img-bg-210);
    }

    .row-item-2 {
      background-image: var(--q-color-com-img-bg-211);
    }

    .row-item-3 {
      background-image: var(--q-color-com-img-bg-212);
    }

    .row-item-4 {
      background-image: var(--q-color-com-img-bg-213);
    }

    .row-item-5 {
      background-image: var(--q-color-com-img-bg-214);
    }

    .row-item-6 {
      background-image: var(--q-color-com-img-bg-215);
    }

    .row-item-7 {
      background-image: var(--q-color-com-img-bg-216);
    }

    .row-item-8 {
      background-image: var(--q-color-com-img-bg-217);
    }

    .row-item-9 {
      background-image: var(--q-color-com-img-bg-218);
    }
