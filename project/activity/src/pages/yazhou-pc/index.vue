        ...
        <div class="container">
          ...
          <div class="tabs">
            <div
              ...
              :class="v.activity == v.activityId ? 'isActive' : ''"
              @click="switchTabs(v.activityId)"
            >
              {{ v.label }}
              <!-- 活动状态图标 -->
              <span class="tips">
          ...
          <!-- 每日任务 -->
          <GrowUp
            v-if="activityBanner == '10007'"
            :id="10007"
            :activityObj="dailyActivityObj"
          />
          <!-- 成长任务 -->
          <GrowUp
            v-if="activityBanner == '10008'"
            :id="10008"
            :activityObj="growthActivityObj"
          />
          <!-- 幸运盲盒 -->
          <LuckyBox
            v-if="activityBanner == '10009'"
            :activityObj="luckActivityObj"
          />
          <!-- 老虎机 -->
          <SlotMachine
            v-if="activityBanner == '10010'"
            :activityObj="slotActivityObj"
          />
        </div>
      </div>
    </load-data>
...
<script>
import LuckyBox from "project/activity/src/pages/yazhou-pc/lucky_box/lucky_box.vue";
import GrowUp from "project/activity/src/pages/yazhou-pc/grow_up/index.vue";
// 老虎机
import SlotMachine from "project/activity/src/pages/yazhou-pc/slot_machine/index.vue";
