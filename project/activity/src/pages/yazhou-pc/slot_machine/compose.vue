...
export default {
  ...
  methods: {
    ...
    scale_func() {
      ...
      if (scaleNum < 1) {
        scalDom.style.setProperty('--activity-scale', scaleNum)
        scalDom.style.setProperty('--activity-margin-top', `-${margin_top}px`)
        scalDom.style.setProperty('--activity-bg-margin-top', `-${margin_top-44}px`)
      } else {
        scalDom.style.setProperty('--activity-scale', 1)
        scalDom.style.setProperty('--activity-margin-top', `0px`)
        scalDom.style.setProperty('--activity-bg-margin-top', `0px`)
      }
    },
    /**
     * 合成奖券配置
