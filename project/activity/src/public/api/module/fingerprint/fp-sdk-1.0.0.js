...
function t () {
    ...
    function l(e, t) {
        t = t || 0;
        for (var n = (e = e || "").length % 16, a = e.length - n, r = [0, t], i = [0, t], o = [0, 0], l = [0, 0], s = [2277735313, 289559509], c = [1291169091, 658871167], u = 0; u < a; u += 16) o = [255 & e.charCodeAt(u + 4) | (255 & e.charCodeAt(u + 5)) << 8 | (255 & e.charCodeAt(u + 6)) << 16 | (255 & e.charCodeAt(u + 7)) << 24, 255 & e.charCodeAt(u) | (255 & e.charCodeAt(u + 1)) << 8 | (255 & e.charCodeAt(u + 2)) << 16 | (255 & e.charCodeAt(u + 3)) << 24],
    ...
    function c(e, t) {
        ...
        a = e.length; n < a; n++) t(e[n], n, e);
        else for (var r in e) e.hasOwnProperty(r) && t(e[r], r, e)
    }
    function s(e, a) {
        var r = [];
        return null == e ? r: Array.prototype.map && e.map === Array.prototype.map ? e.map(a) : (c(e,
        function(e, t, n) {
            r.push(a(e, t, n))
        }), r)
    }
    function u(e) {
        throw new Error("'new Fp()' is deprecated")
    }
    var e = {
        preprocessor: null,
        audio: {
    ...
    T = function(e) {
        for (var t = !1,
        n = 0,
        a = e.plugins.sortPluginsFor.length; n < a; n++) {
    ...
    G = function(t, e) {
        ...
        var a, r, i = e.fonts.swfContainerId; (r = document.createElement("div")).setAttribute("id", a.fonts.swfContainerId),
    ...
    },
    {
        key: "plugins",
        getData: function(e, t) {
            D() ? t.plugins.excludeIE ? e(t.EXCLUDED) : e(o(t)) : e(i(t))
        }
    },
    {
        key: "canvas",
    ...
    },
    {
        ...
        getData: function(e, t) {
            ...
            function n(e) {
                for (var t = !1,
                n = 0; n < u.length; n++) if (t = e[n].offsetWidth !== i[u[n]] || e[n].offsetHeight !== o[u[n]]) return t;
                return t
            }
            ...
            a.appendChild(r);
            for (var s = 0,
            c = u.length; s < c; s++) i[u[s]] = l[s].offsetWidth,
            o[u[s]] = l[s].offsetHeight;
            var h = function() {
                for (var e, t, n, a = {},
                r = 0,
                i = d.length; r < i; r++) {
    ...
    },
    {
        ...
        getData: function(n, e) {
            ...
            var l = setTimeout(function() {
                return console.warn('Audio fingerprint timed out. Please report bug with your user agent: "' + navigator.userAgent + '".'),
    ...
    return u.get = function(n, a) { (function(e, t) {
            if (null == t) return;
            var n, a;
