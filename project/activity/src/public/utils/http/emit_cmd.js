...
// 获取单关滚动条的高度
export const EMIT_BET_SINGLE_SCROLL_HEIGHT_CMD = 'EMIT_BET_SINGLE_SCROLL_HEIGHT';
// 串关的校验金额
...
// 获取账户金额
export const EMIT_GET_BALANCE_CMD = 'EMIT_GET_BALANCE';
// 单关滚动条位置初始化
...
// 更新赛事详情对应投注项数据
export const EMIT_DETAIL_UPDATE_TARGET_OBJ_CMD = "EMIT_DETAIL_UPDATE_TARGET_OBJ";
// 获取赛事信息
...
// 改变分页
export const EMIT_RECORD_CHANGE_PAGE_SIZE_CMD = "EMIT_RECORD_CHANGE_PAGE_SIZE_CMD";
...
// 重新调用单关最大最小值接口
export const EMIT_BET_SINGLE_RECALL_MONEY_CMD = "EMIT_BET_SINGLE_RECALL_MONEY_CMD";
...
// 检查单关无效的金额
export const EMIT_SINGLE_CHECK_VALID_MOENY_CMD = "EMIT_SINGLE_CHECK_VALID_MOENY_CMD";
...
export const EMIT_BET_MIX_CHANGE_MATCH_UPDATE = "EMIT_BET_MIX_CHANGE_MATCH_UPDATE";
...
// 未结算订单统计
export const EMIT_UNSETTLE_TICKETS_COUNT_CMD =  "EMIT_UNSETTLE_TICKETS_COUNT_CMD";
// 获取提前结算按钮上的金额
...
export const EMIT_DEL_BOOK_HISTORY_RECORD_CMD = "EMIT_DEL_BOOK_HISTORY_RECORD_CMD";
// 情况多项输入框
...
//更新提前结算订单数据信息
export const EMIT_UPD_CASHOUT_MAX_AMOUNT_LIST_CMD = "EMIT_UPD_CASHOUT_MAX_AMOUNT_LIST_CMD"
//------------------------------------------------------------------命令定义-E-------------------------------------------------------------------------------------
