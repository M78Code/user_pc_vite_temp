...
import { api_search } from "project/activity/src/public/api/index.js";
...
export default {
  ...
  */
    ...
    api_search.get_search_result(params).then( res => {
      ...
      // let list = this.get_result_list(_.get(sports_list,'[0].id'))
  ...
  */
  get_result_data(res,csid){
    let list = []
    let bowling_list = _.get(res,'data.data.data.bowling') || []
    let league_list = _.get(res,'data.data.data.league') || []
    let team_list = _.get(res,'data.data.data.team') || []
  ...
  */
  get_result_sports_list(res){
    let list = []
    let sports_list = _.get(res,'data.data.sportIdList') || []
