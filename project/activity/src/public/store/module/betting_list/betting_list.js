...
export default {
  ...
  getters: {
     ...
     * @param {*} state
     */
    get_bet_single_obj(state) {
      return state.bet_single_obj;
    },
    get_is_single_handle(state) {
     ...
     * @returns  是否合并
     */
    get_is_bet_merge(state) {
      return state.is_bet_merge;
    },
    get_bet_category(state) {
     ...
     * @returns 
     */
    get_bet_appoint_obj(state) {
      return state.bet_appoint_obj;
    },
    get_bet_current_money_obj(state) {
  ...
  mutations: {
     ...
     * @returns
     */
    set_chat_room_type(state, chat_room_type){
     ...
     * @param {*} pre_bet_list
     */
    set_pre_bet_list(state, pre_bet_list) {
