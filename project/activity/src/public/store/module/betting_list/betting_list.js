...
const bettingStore = {
  ...
  actions: {
    ...
    set_virtual_bet_s_obj(virtual_bet_s_obj) {
    ...
    virtual_bet_s_clear(key) {
      commit('virtual_bet_s_clear', key);
    },
    virtual_bet_clear(key) {
...
function commit(flag, ...args) {
  return bettingStore.mutations[flag].apply(null, ...args);
}
