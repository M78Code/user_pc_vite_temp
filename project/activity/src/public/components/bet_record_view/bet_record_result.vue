                  ...
                  <div class="col-12 bet-compute-money">
                    ...
                    <vue-slider
                      ...
                      <template v-slot:label="{ label, active }">
                        <div :class="['vue-slider-mark-label', 'custom-label', {active:active&&money_obj.slider_index*money_obj.step==label/10}]">{{ label }}%</div>
                      </template>
                    </vue-slider>
                  </div>
  ...
  .bet-pre-wrap {
    ...
    .bet-pre-btn {
      ...
      div {
        ...
        &.bet-row-1 {
          margin-top: 6px;
          color:var(--qq--bet-pre-btn-text-color)           
        }
        &.bet-row-2 {
          margin-top: -3px;
          color:var(--qq--bet-pre-money-text-color)
        }
      }
      &:hover {
        cursor: pointer;
  ...
  .bet-pre-complete-btn {
    ...
    .bet-pre-left {
      ...
      div {
        ...
        &.bet-row-1 {
          margin-top: 5px;
          color:var(--qq--bet-pre-confirming-text-color) !important;
        }
        &.bet-row-2 {
          margin-top: -3px;
          color:var(--qq--bet-pre-confirming-text-color) !important;
...
.active{
  font-weight: 500;
  color:var(--qq--theme-menu-text-active) !important;
}
