  ...
  .line {
    ...
    .item-line {
      ...
      .bar-progress {
        ...
        width: 100%;
        height: 6px;
        background: var(--qq--details-chat-origin);
        border-radius: 5px;
        .progress-content {
          position: absolute;
          top: 0;
          left: 0;
          height: 6px;
          background: var(--qq--details-chat-blue);
...
::v-deep {
  .text-blue {
    color: var(--qq--details-chat-blue) !important;
  }
  .text-orange {
    color: var(--qq--details-chat-origin) !important;
  }
  .text-light-blue-13 {
    color: var(--qq--details-chat-blue) !important;
  }
