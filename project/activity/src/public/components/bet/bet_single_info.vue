...
export default {
  ...
  components: {
    tips: () => import( /* webpackChunkName: "pc-mini-chunks" */ "src/public/components/match_list/pre_tip.vue")
  },
  props: {
    is_forward: {
      type:Number,
...
.bet-odds-value {
 ...
 .col-delete {
  ...
  align-items: center;
  background: var(--qq--theme-bg-bet-text-delete);
  ...
  .bet-del {
    ...
    z-index: 20;
    &.icon-del::before{
      color: var(--qq--theme-bet-text-delete-color);
    }
     /* *按钮划过的样式* */
    &:hover {
      .icon-del::before {
