    ...
    <q-card-section>
      ...
      <template v-if="is_show_keyboard">
        <div class="row bet-win yb-fontsize12">
          ...
          <!--最高可赢金额-->
          <div class="col-auto bet-win-money yb-number-bold">{{get_max_win_money() |four_five_six_double(2)}}</div>
        </div>
...
<script>
import bet_mix_input from "src/public/mixins/bet/bet_mix_input.js";
export default {
  // 串关金额输入mixin
