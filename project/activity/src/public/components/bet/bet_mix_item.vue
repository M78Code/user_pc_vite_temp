...
<template>
  ...
  >
    ...
    <q-card-section>
      ...
      <div class="bet-content" id="chuanguan">
        <div class="row">
...
<script>
import bet_mix_item from "src/public/mixins/bet/bet_mix_item.js";
export default {
  // 串关投注mixin
  mixins: [bet_mix_item]
};
...
#chuanguan.bet-content{
  background: var(--qq--chuanguan-bg-color);
}
/*  卡片样式 总的*/
.bet-mix-item-card {
  padding: 15px 10px;
