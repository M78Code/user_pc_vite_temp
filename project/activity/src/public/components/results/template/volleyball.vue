        ...
        res.forEach(item => {
          ...
          if(item.scoreResult != ""){
            obj.home = parseInt(_.get(item, "scoreResult.S120.home")||0) + 
                        ...
                        parseInt(_.get(item, "scoreResult.S125.home")||0) +
                        parseInt(_.get(item, "scoreResult.S126.home")||0)
            ...
            obj.away = parseInt(_.get(item, "scoreResult.S120.away")||0) + 
                        ...
                        parseInt(_.get(item, "scoreResult.S125.away")||0) +
                        parseInt(_.get(item, "scoreResult.S126.away")||0)
          }
