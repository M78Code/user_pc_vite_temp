    ...
    <q-card-section>
      <div class="row">
        <div class="col bet-play-game">
          <label class="bet-play-text">{{_.trim(item_obj.playName)}}<label class="bet-handicap-name">[{{$root.$t('odds')[item_obj.marketType]}}]</label></label>          
        </div>
     ...
     <!--虚拟赛马,虚拟赛狗,虚拟摩托车,泥地摩托车-->
      ...
      <div class="row no-wrap">
        ...
        <div class="col-auto bet-odds-value"
          :class="{
...
<script>
import bet_mix_record_item from "src/public/mixins/virtual_bet2/bet_mix_record_item.js";
export default {
  // 投注记录投注项组件
