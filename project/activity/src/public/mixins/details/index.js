 ...
 */
import mathStore from 'project/activity/src/public/store/module/match_details/index.js';
...
export default {
    methods: {
        set_active_detail(args) {
            return mathStore.mutations.set_active_detail(args);
        },
        /**
