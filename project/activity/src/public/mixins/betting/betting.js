...
export default {
  ...
  computed: {
    vx_get_pre_bet_list() {
        return bettingStore.getters.get_pre_bet_list()
    },
    vx_get_pre_min_odd_value() {
        return bettingStore.getters.get_pre_min_odd_value()
    }
  },
  methods: {
    vx_set_pre_bet_list(list) {
        return bettingStore.mutations.set_pre_bet_list(list)
    },
    /**
