 ...
 * 实现 匹配不到 后 向下 取值
 */
import conversionStore from 'project/activity/src/public/store/module/odds_conversion/odds_conversion';
...
      }
  ...
  computed: {
    vx_odds_coversion_map() {
        return conversionStore.getters.get_odds_coversion_map()
    },
    vx_get_chat_room_type() {
        return bettingStore.getters.get_chat_room_type()
    },
    odds_constant(){
      // 欧洲赔率  1  
      // 香港赔率  2  
