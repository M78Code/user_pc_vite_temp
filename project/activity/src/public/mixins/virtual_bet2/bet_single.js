...
export default {
  ...
  watch: {
    ...
    vx_get_virtual_bet_list: {
      handler(new_) {
        ...
        let is_common_amount = localStorage.getItem("is_common_amount") || false;
  ...
  methods: {
    ...mapActions({
      vx_set_is_virtual_handle: "set_is_virtual_handle", //虚拟体育投注处理中
      vx_set_virtual_bet_list: "set_virtual_bet_list",  // 设置虚拟投注列表
      vx_set_show_login_popup: "set_show_login_popup", 
      vx_virtual_bet_obj_add: "virtual_bet_obj_add",  //添加投注对象
      vx_virtual_bet_obj_del: "virtual_bet_obj_del", //删除投注对象
      vx_set_menu_change: "set_menu_change", //菜单改变
      vx_set_virtual_bet_mode: "set_virtual_bet_mode", //投注模式
      
      vx_set_bet_item_lock: 'set_bet_item_lock', // 投注项是否锁住设置
      ...
      vx_virtual_bet_clear: "virtual_bet_clear",  //清除投注
    ...
    submit_handle(handle_type) {
      ...
      let obj = this.yabo_common.query_selector('.cathectic-zone input')
    ...
    toggle_amount(value) {
      this.is_common_amount = value;
      localStorage.setItem("is_common_amount", value);
    },
    toggle_bet_prefer() {
