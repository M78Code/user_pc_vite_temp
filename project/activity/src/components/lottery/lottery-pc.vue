...
.card-wrap {
  ...
  &.diamond_card {
    ...
    .big-ring {
      ...
      &.active:after {
        background-image: url("~public/image/activity_imgs/imgs/slot_machine/diamond_active.png");
      }
      .small-ring:after {
  ...
  &.gold_card {
    ...
    .big-ring {
      ...
      &.active:after {
        background-image: url("~public/image/activity_imgs/imgs/slot_machine/gold_active.png");
      }
      .small-ring:after {
  ...
  &.silver_card {
    ...
    .big-ring {
      ...
      &.active:after {
        background-image: url("~public/image/activity_imgs/imgs/slot_machine/silver_active.png");
      }
      .small-ring:after {
