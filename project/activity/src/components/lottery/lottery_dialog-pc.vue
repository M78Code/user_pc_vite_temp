...
<template>
  <q-dialog v-model="isShow">
      <q-layout view="Lhh lpR fff" container class="lottery">
        <img class="close" src="/activity/yazhou-pc/activity_imgs/imgs/dialog_close.png" alt="" @click.stop="$emit('close_lottery_dialog')" width="30px">
        <div class="content">
          ...
          <img v-if="getLotterySuc" src="/activity/yazhou-pc/activity_imgs/imgs/get_lottery_suc.png" alt="">
          <img v-if="!getLotterySuc" src="/activity/yazhou-pc/activity_imgs/imgs/get_lottery_fail.png" alt="">
