...
<template>
  ...
  <q-layout view="lHh Lpr lFf" class="layout_container">
    <q-page-container id="app-h5" class="page_container" :style="`height:${inner_height}px`">
      ...
      <!-- 串关投注 只有串关/电竞/VR 才展示--> 
      <q-page-sticky position="bottom-right" :offset="fabPos" v-if="!BetData.is_bet_single && (is_mix||is_esports||is_vr|| is_detail) && BetData.bet_s_list.length">
...
import {is_mix,is_esports,is_vr, is_detail} from "src/base-h5/mixin/menu.js"
