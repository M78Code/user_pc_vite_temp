        ...
        <div class="hairline-border">
            <div class="content-wrapper">
                ...
                <div class="row head yb_mb4">
                    ...
                    <div class="col text-center ellipsis yb_px4" v-for="(item,index) in item_data.title" :key="index">
                        {{ item.osn }}
                    </div>
                </div>
                    ...
                    <div class="col col-mg yb_fontsize14" style="min-width: 1px;">
                        <template v-for="(ol_item,ol_index) in item.ol">
                            <div v-if="lodash.get(item_data.title,'[0].otd') == ol_item.otd" :key="ol_index"
                                 class="ellipsis font_color play-box-style">
                                {{ ol_item.on }}
                            </div>
                        </template>
                    </div>
                        ...
                        <template v-for="(ol_item,ol_index) in item.ol">
                            <div v-if="lodash.get(item_data.title,'[0].otd') == ol_item.otd" :key="ol_index">
                                ...
                                <template v-if="ol_item._mhs == 1">
                                    <!-- lock 锁状态 start -->
                                    <div class="play-box-style"><img
                                        :src="`${LOCAL_PROJECT_FILE_PREFIX}/image/common/match-icon-lock.svg`"></div>
                                    <!-- lock 锁状态 end -->
                                </template>
                                <!-- 关盘 -->
                            ...
                            <template v-if="ol_item._mhs == 0 || ol_item._mhs == 11">
                                ...
                                <template v-if="ol_item._hs == 0 || ol_item._hs == 11">
                                    ...
                                    <template v-if="ol_item.os == 2">
                                        <!-- lock 锁状态 start -->
                                        <div class="ellipsis remark play-box-style bw_mr1">{{ ol_item.on }}</div>
                                        <div class="play-box-style col"><img
                                            :src="`${LOCAL_PROJECT_FILE_PREFIX}/image/common/match-icon-lock.svg`">
                                        </div>
                                        <!-- lock 锁状态 end -->
                                    </template>
