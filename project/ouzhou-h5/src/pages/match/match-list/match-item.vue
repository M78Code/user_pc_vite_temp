            ...
            <div :class="['match-inner-container', { 'collapsed': !collapsed }]">
                ...
                <div @click="handle_league_fold" v-if="match.is_show_league || (is_hot && get_league_show(i))"
                    ...
                    <div class="league-t-wrap">
                        ...
                        <!-- 联赛收藏 -->
                        <div v-if="![3000, 900].includes(menu_type)" class="favorited-icon"
                        ...
                        <span class="league-title-text row justify-between">
                            <span
                                :class="['league-t-wrapper', { 'league-t-main-wrapper': menu_type !== 28, export: is_export }]">
                                <span class="match-league ellipsis-2-lines"
                                    :class="{ 'match-main-league': menu_type !== 28 }">
                                    {{ match.tn }}
                                </span>
                            </span>
                    ...
                    <div :class="['match-odds-container study_height_s hairline-border']">
                        <div class="match-odds-container-border-radius">
                            ...
                            <div class="odd-list match-indent"
                                :class="{ 'simple': show_newer_edition, result: is_results }">
                                <div class="odd-list-inner odd"
                                    :class="{ 'n-s-edition': !show_newer_edition, result: is_results }">
                                    ...
                                    <div @click='goto_details(match)'
                                        ...
                                        <div class="date-container match-indent" v-if="!show_newer_edition && !is_results">
                                            <div class='l standard'>
                                                ...
                                                <div class="favorite-icon-top match list-m"
                                                    @click.stop="handle_match_collect">
                                                ...
                                                <div
                                                    ...
                                                    <!-- 赛事回合数mfo -->
                                                    <div v-if="match.mfo" class="mfo-title"
                                                        :class="{ 'is-ms1': match.ms == 1 }">
                                                        {{ match.mfo }}
                                                    </div>
                                                    ...
                                                    <div class="start-counting-down"
                                                        ...
                                                        <CountingDownStart :match="match" :index="i" :mgt_time="match.mgt">
                                                        </CountingDownStart>
                                                    </div>
                                                    <!--倒计时或正计时-->
                                                    <div v-if="match.ms != 110 && show_counting_down(match)"
                                                        ...
                                                        <CountingDownSecond ref="counting-down-second"
                                                            :title="mmp_map_title" :mmp="match.mmp"
                                                            :is_add="[1, 4, 11, 14, 100, 101, 102, 103].includes(+match.csid)"
                                                            :m_id="match.mid" :second="match.mst" :match="match"
                                            ...
                                            <div class="goto-detail" @click='goto_details(match)'>
                                                <span class="count_span" :class="{ esports: 3000 == menu_type }">
                                                    ...
                                                    <span class="add_text" v-if="GlobalAccessConfig.get_handicapNum()">
                                                        <IconWapper color="#888" name="icon-triangle1" size="14px"
                                                            class="icon-wapper-more" />
                                                    </span>
                                                </span>
                                            </div>
                                        </div>
                                        ...
                                        <div class='team-title-container' :class="{
                                            ...
                                            <div class="team-title-inner-con">
                                                ...
                                                <div class="yb-flex-center"
                                                    v-if="is_show_home_goal && is_new_init2 && (!is_show_away_goal)">
                                                    <div class="yb-goal-gif"
                                                        :class="{ 'yb-goal-yo': theme.includes('y0') }"></div>
                                                    <div class="gif-text">{{ $t('match_result.goal') }}</div>
                                                </div>
                                            </div>
                                            <!--进行中的赛事显示比分 ,如果是比分判定中，则不显示比分-->
                                            <div class="score full-score"
                                                v-show="match.ms > 0 && !is_results && !eports_scoring"
                                        ...
                                        <div class='team-title-container'>
                                            ...
                                            <div class="team-title-inner-con">
                                                ...
                                                <!-- 进球动画 -->
                                                <div class="yb-flex-center"
                                                    v-if="is_show_away_goal && is_new_init2 && (!is_show_home_goal)">
                                            ...
                                            <!--进行中的赛事显示比分 ,如果是比分判定中，则不显示比分-->
                                            <div class="score full-score"
                                                v-show="match_of_list.ms > 0 && !is_results && !eports_scoring"
