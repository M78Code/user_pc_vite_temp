import { ref, reactive,isRef, unref, watch, onMounted} from 'vue'
...
function use_init_menu(){
    ...
    // 常规体育d
    let menu_1_base = reactive([101, 102, 2000, 105, 107, 110, 108, 103, 109, 111, 112, 113, 116, 115,114, 104, 106, 118, 400])
