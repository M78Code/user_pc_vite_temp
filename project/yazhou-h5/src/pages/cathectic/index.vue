...
<template>
    <div class="settle-dialog">
      ...
      <div class="content-m" ref="record_box">
        <!--未结算  v-show="store_data.main_item == 0"-->
        <unsettle ref="unsettleChild"></unsettle>
        <!--已结算-->
        <!-- <settle v-show="store_data.main_item == 1"></settle> -->
        <!--预约-->
        <!-- <preRecord v-show="store_data.main_item == 2"></preRecord> -->
      </div>
    </div>
  </template>
