        ...
        */
        const cancle_pre_order = () => {
            ...
            if(res.code == 200){
                ...
                cancle_confirm_pop_visible.value = false
                // TODO 从vuex取待改造
                // this.set_toast({ 'txt':res.code == '0400546'? this.$root.$t('pre_record.cancle_fail_tips'):this.$root.$t('pre_record.cancle_fail_tips2'), hide_time: 3000 });
            }
            }).catch(()=>{
            cancle_confirm_pop_visible.value = false
            })
