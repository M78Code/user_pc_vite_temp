...
export default defineComponent({
  ...
  components: {
    // 队标视图
    "team-img": defineAsyncComponent(() => import("src/project/components/details/team_img.vue")),  
    // 全屏播放时，顶部title
    "title-x": defineAsyncComponent(() => import("src/project/pages/details/analysis-matches/components/title_x.vue")),
    // 事件类型菜单  
    "tabs": defineAsyncComponent(() => import("src/project/pages/details/analysis-matches/components/tabs.vue")), 
    // 精彩回放视频滚动列表  
    "slider-x": defineAsyncComponent(() => import("src/project/pages/details/analysis-matches/components/slider_x.vue")),   
  },
  directives: {
    // 对阵文案过长时，无限滚动展示
    'scroll-text': {
