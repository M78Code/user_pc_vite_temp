      ...
      <div class="table-score-wrapper">
        <div class="table-score">
          ...
          <div class="header">
            ...
            <div class="alliance—col3">{{i18n.t('analysis_football_matches.victory') }}</div>
            <div class="alliance—col3">{{i18n.t('analysis_football_matches.negative') }}</div>
            <div class="col5">{{ i18n.t('home_popular.win_rate') }}</div>
          </div>
          <!-- 主内容 -->
    ...
    <template v-if="tab_name_index == 2 && liat_data && liat_data.length>0">
      <div class="table-score-wrapper">
        <div class="table-score">
          ...
          <div class="header">
            <div class="col1">{{i18n.t('analysis_football_matches.rank') }}</div>
            <div class="col2">{{ i18n.t('home_popular.player') }}</div>
            <div class="rebounds—col3">{{i18n.t('analysis_football_matches.team') }}</div>
            <div class="col5">
              {{public_form_title.type == '2' ? i18n.t('home_popular.assist') : public_form_title.type == '5' ? i18n.t('match_result.goal') : i18n.t('home_popular.average')}}
            </div>
          </div>
          <!-- 主内容 -->
          <div class="group-item">
      ...
      <div class="table-score-wrapper">
        <div class="table-score">
          ...
          <div class="header">
            <div class="col1">{{i18n.t('analysis_football_matches.rank') }}</div>
            <div class="col2">{{i18n.t('analysis_football_matches.team') }}</div>
            <div class="col3">{{i18n.t('analysis_football_matches.game') }}</div>
            <div class="col3">{{i18n.t('analysis_football_matches.victory') }}</div>
            <div class="col3">{{i18n.t('analysis_football_matches.negative') }}</div>
            <div class="col3">{{i18n.t('analysis_football_matches.flat') }}</div>
            <div class="col4">{{i18n.t('analysis_football_matches.gain_loss') }}</div>
            <div class="col4">{{i18n.t('analysis_football_matches.net_win') }}</div>
            <div class="col5">{{i18n.t('analysis_football_matches.integral') }}</div>
          </div>
          <!-- 主内容 -->
          <div class="group-item">
            <div class="team-item" v-for="(item, i) in liat_data" :key="i" :class="{ 'black-font':  i<3}">
