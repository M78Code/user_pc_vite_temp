      ...
      <div class="table-score-wrapper">
        <div class="table-score">
          ...
          <div class="header">
            ...
            <div class="alliance—col3">{{$root.$t('analysis_football_matches.victory') }}</div>
            <div class="alliance—col3">{{$root.$t('analysis_football_matches.negative') }}</div>
            <div class="col5">{{ $root.$t('home_popular.win_rate') }}</div>
          </div>
          <!-- 主内容 -->
    ...
    <template v-if="tab_name_index == 2 && liat_data && liat_data.length>0">
      <div class="table-score-wrapper">
        <div class="table-score">
          ...
          <div class="header">
            <div class="col1">{{$root.$t('analysis_football_matches.rank') }}</div>
            <div class="col2">{{ $root.$t('home_popular.player') }}</div>
            <div class="rebounds—col3">{{$root.$t('analysis_football_matches.team') }}</div>
            <div class="col5">
              {{public_form_title.type == '2' ? $root.$t('home_popular.assist') : public_form_title.type == '5' ? $root.$t('match_result.goal') : $root.$t('home_popular.average')}}
            </div>
          </div>
          <!-- 主内容 -->
          <div class="group-item">
      ...
      <div class="table-score-wrapper">
        <div class="table-score">
          ...
          <div class="header">
            <div class="col1">{{$root.$t('analysis_football_matches.rank') }}</div>
            <div class="col2">{{$root.$t('analysis_football_matches.team') }}</div>
            <div class="col3">{{$root.$t('analysis_football_matches.game') }}</div>
            <div class="col3">{{$root.$t('analysis_football_matches.victory') }}</div>
            <div class="col3">{{$root.$t('analysis_football_matches.negative') }}</div>
            <div class="col3">{{$root.$t('analysis_football_matches.flat') }}</div>
            <div class="col4">{{$root.$t('analysis_football_matches.gain_loss') }}</div>
            <div class="col4">{{$root.$t('analysis_football_matches.net_win') }}</div>
            <div class="col5">{{$root.$t('analysis_football_matches.integral') }}</div>
          </div>
          <!-- 主内容 -->
          <div class="group-item">
            <div class="team-item" v-for="(item, i) in liat_data" :key="i" :class="{ 'black-font':  i<3}">
