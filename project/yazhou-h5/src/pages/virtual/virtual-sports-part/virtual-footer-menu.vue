  ...
  setup(props, evnet) {
    ...
    */
    ...
    const footer_sub_m_list = computed(() => {
      return [
        {
          title:this.get_lang=='en'?'':this.$root.$t('footer_menu.full_time'),
          title1:this.$root.$t('footer_menu.win_alone'),
        ...
        {
          title:this.get_lang=='en'?'':this.$root.$t('footer_menu.full_time'),
          title1:this.$root.$t('footer_menu.rangqiu'),
        ...
        {
          title:this.get_lang=='en'?'':this.$root.$t('footer_menu.full_time'),
          title1:this.$root.$t('footer_menu.daxiao'),
