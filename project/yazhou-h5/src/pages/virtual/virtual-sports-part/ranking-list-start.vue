  ...
  <div class="ranking_list_satrt">
    <template v-if="!no_data">
      ...
      <div class="ranking-item-top">
        ...
        <div class="right">
          <span>{{ $root.$t('virtual_sports.vitality_performance') }}</span>
