...
export const video_info = () => {
    ...
    const component_data = reactive({
      ...
      voice_act: "image/wwwassets/bw3/svg/video_h.svg",
      // nail_def: "image/wwwassets/bw3/svg/video_f.svg",
      // nail_act: "image/wwwassets/bw3/svg/video_e.svg",
      donghua: "image/wwwassets/bw3/svg/v-donghua.svg",
      // 直播 切换的图标
      shipin: "image/wwwassets/bw3/svg/v-shipin.svg",
      // 演播厅 切换的图标
      studio_icon:"image/wwwassets/bw3/svg/studio_icon.svg",
      // 赛前直播的
      lvs_icon_pre : "image/wwwassets/bw3/common/zhibo-before.svg",
      // ding1: "image/wwwassets/bw3/svg/ding1.svg",
      // ding2: "image/wwwassets/bw3/svg/ding2.svg",
      bet: "image/wwwassets/bw3/svg/bet.svg",
      analyze: "image/wwwassets/bw3/svg/analyse.svg",
      analyze2: "image/wwwassets/bw3/svg/analyse2.svg",
      analyze_yo: "image/wwwassets/bw3/svg/analyse2_y0.svg",
      analyze2_y0: "image/wwwassets/bw3/svg/analyse_y0.svg",
      select_item:-1,
      voice: true,
      nail: true,
