<template>
  <div class='header-bottom'>
    <!-- 动画+视频 按钮 收藏按钮 -->
    <team-match-icon v-if="!['result_details', 'match_result'].includes(this.$route.name)"></team-match-icon>
...
import team_match_icon from "src/project/components/details/team_match_icon.vue"  // 动画和视频按钮的展示
