...
import teamMatchIcon from "project_path/src/components/details/team-match-icon.vue"  // 动画和视频按钮的展示
import matchScore from 'project_path/src/components/match/match-score.vue'  // 详情页所有球种的细节比分展示条
