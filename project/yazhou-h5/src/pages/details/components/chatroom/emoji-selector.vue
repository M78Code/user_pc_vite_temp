<!--
 * @FilePath: d:/projects/user-h5/project_path/src/pages/details/components/chatroom/emoji_selector.vue
 * @Description:
-->

<template>
  <div class="popper t-popper">
    <img src="image/wwwassets/bw3/svg/bet_close.svg" class="close_icon" @click.stop="onEmojiSelect('')" />
