...
<template>
  <div class="marquee-wrap" :ref="refs.marquee_wrap">
    <!-- 滚动内容 -->
    <div class="scroll_wrap" :ref="refs.scroll_wrap">
...
function move(text_width, scroll) {
...
const refs = reactive({
  marquee_wrap: ref(null),
  scroll_wrap: ref(null),
  full_content: ref(null)
})
function init() {
  // TODO: 待验证
  let dom_ = refs
