...
declare module 'src/core/mitt/index.js' {
  ...
  function useMittEmit(type: typeof MITT_TYPES_PROJECT.EMIT_REFRESH_DETAILS, param: MATCH.mid | MATCH.csid | MATCH.tid | MITT.Refresh): void;
  /** 订阅EMIT_REFRESH_DETAILS 详情刷新事件 */
  function useMittOn(type: typeof MITT_TYPES_PROJECT.EMIT_REFRESH_DETAILS, 
    callback: (param: MATCH.mid | MATCH.csid | MATCH.tid | MITT.Refresh) => void): MITT.UseMittOnResult;
}
