!function(e, t) {
    ...
    , function(e, t, a) {
        ...
        (function(t) {
            ...
            var l, s = {
                adapter: (("undefined" != typeof XMLHttpRequest || void 0 !== t && "[object process]" === Object.prototype.toString.call(t)) && (l = a(10)),
                l),
    ...
    , function(e, t, a) {
        ...
        var p = {
          ...
          , c = function(e) {
            ...
            this.tran = function(e) {
                return p[t.lang] && p[t.lang][e] ? p[t.lang][e] : e
            }
        }
          , u = a(17)
          , y = a.n(u)
        ...
        var me = function() {
            ...
            (a = [{
                ...
                value: function() {
                    var e = this;
                    this.player.options.video.thumbnails && (this.thumbnails = new ye({
                ...
                value: function() {
                    ...
                    this.player.template.volumeButtonIcon.addEventListener("click", (function() {
                        ...
                        e.player.template.volumeIcon.innerHTML = N.volumeOff,
        ...
        var Te = function() {
            ...
            (a = [{
                ...
                key: "update",
                value: function() {
                    this.template.infoVersion.innerHTML = "v".concat("1.25.1", " ").concat("8907d2e"),
        ...
        var ze = 0
          ...
          , Oe = function() {
            function e(t) {
                ...
                this.tran = new c(this.options.lang).tran,
                this.events = new G,
                ...
                this.bezel = new ce(this.template.bezel),
                this.fullScreen = new te(this),
                this.controller = new me(this),
                this.options.danmaku && (this.danmaku = new K({
                ...
                this.paused = !0,
                this.timer = new de(this),
                this.hotkey = new we(this),
                this.contextmenu = new ke(this),
                this.initVideo(this.video, this.quality && this.quality.type || this.options.video.type),
                this.infoPanel = new Te(this),
            ...
            (a = [{
                ...
                value: function(e) {
                    var t = this;
                    if (this.paused = !1,
                    this.video.paused && !r.isMobile && this.bezel.switch(N.play),
                    this.template.playButton.innerHTML = N.pause,
                    this.template.mobilePlayButton.innerHTML = N.pause,
                ...
                value: function(e) {
                    ...
                    this.video.paused || r.isMobile || this.bezel.switch(N.pause),
                    this.template.playButton.innerHTML = N.play,
                    this.template.mobilePlayButton.innerHTML = N.play,
                    e || this.video.pause(),
                ...
                value: function() {
                    this.volume() >= .95 ? this.template.volumeIcon.innerHTML = N.volumeUp : this.volume() > 0 ? this.template.volumeIcon.innerHTML = N.volumeDown : this.template.volumeIcon.innerHTML = N.volumeOff
                }
            }, {
                key: "volume",
                value: function(e, t, a) {
