      ...
      <div class="menu-inner" @click.stop="" :style="{width:`${calc_width}px`}">
        ...
        <div class="set-item">
          ...
          <div class="option" @click="change_odd">
            <div class="op-item active">{{BetData.set_cur_odd == 'EU'?i18n_t("setting_menu.odd_europe2"):i18n_t("setting_menu.odd_hong_kong2")}}</div>
            <div class="op-icon"></div>
            <div class="op-item">{{BetData.set_cur_odd == 'EU'?i18n_t("setting_menu.odd_hong_kong2"):i18n_t("setting_menu.odd_europe2")}}</div>
          </div>
        </div>
        <!-- 赔率 -->
        <div class="set-item no-border">
          ...
          <div class="option" @click="set_is_accept">
            <div class="op-item active">{{BetData.bet_is_accept == 2?i18n_t("setting_menu.odd_any2"):i18n_t("setting_menu.odd_optimal2")}}</div>
            <div class="op-icon"></div>
            <div class="op-item">{{BetData.bet_is_accept == 2?i18n_t("setting_menu.odd_optimal2"):i18n_t("setting_menu.odd_any2")}}</div>
          </div>
        </div>
        <div class="line"></div>
        <!-- 版本 -->
        <div class="set-item">
          ...
          <div class="option" @click="change_edition">
            <div class="op-item active">{{get_newer_standard_edition == 2?i18n_t("setting_menu.standard"):i18n_t("setting_menu.concise")}}</div>
            <div class="op-icon"></div>
            <div class="op-item">{{get_newer_standard_edition == 2?i18n_t("setting_menu.concise"):i18n_t("setting_menu.standard")}}</div>
          </div>
        </div>
        <!-- 语言 -->
        <div class="set-item no-border">
...
import BetData from "src/core/bet/class/bet-data-class.js";
  ...
  const setting_language_handle = (key) => {
      ...
      loadLanguageAsync(key).then((res)=>{
        ...
        $toast(i18n_t('pre_record.cancle_fail_tips'), 2000);
      }).finally((res) => {
