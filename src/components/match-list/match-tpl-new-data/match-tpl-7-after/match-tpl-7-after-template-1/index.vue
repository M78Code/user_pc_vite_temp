<template>
  <div class="c-match-item " :class="{ 'more-handicap': match.has_add1 || match.has_add2 || match.is_show_cur_handicap }">
    <!-- 比赛进程 -->
    ...
    <div class="match-handicap-item-wrap">
      ...
      <div class="match-handicap-item" v-if="match.is_show_cur_handicap">
        ...
        <!-- 赛事盘口投注项 -->
        <match-handicap :handicap_list="match.cur_handicap_list" :match="match" is_show_score />
