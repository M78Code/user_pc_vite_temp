...
export default defineComponent({
  ...
  components: {
    // 模板id=0(默认模板)
    temp0: () => import(/* webpackChunkName: "user-h5-min-sm" */ "./temp0.vue"),
    // 模板id=1
    temp1: () => import(/* webpackChunkName: "user-h5-min-sm" */ "./temp1.vue"),
    // 模板id=2
    temp2: () => import(/* webpackChunkName: "user-h5-min-sm" */ "./temp2.vue"),
    // 模板id=3
    temp3: () => import(/* webpackChunkName: "user-h5-min-sm" */ "./temp3.vue"),
    // 模板id=4
    temp4: () => import(/* webpackChunkName: "user-h5-min-sm" */ "./temp4.vue"),
    // 模板id=5
    temp5: () => import(/* webpackChunkName: "user-h5-min-sm" */ "./temp5.vue"),
    // 模板id=6
    temp6: () => import(/* webpackChunkName: "user-h5-min-sm" */ "./temp6.vue"),
    // 模板id=7
    temp7: () => import(/* webpackChunkName: "user-h5-min-sm" */ "./temp7.vue"),
    // 模板id=8
    temp8: () => import(/* webpackChunkName: "user-h5-min-sm" */ "./temp8.vue"),
    // 模板id=9
    temp9: () => import(/* webpackChunkName: "user-h5-min-sm" */ "./temp9.vue"),
    // 模板id=10
    temp10: () => import(/* webpackChunkName: "user-h5-min-sm" */ "./temp10.vue"),
    // 模板id=11
    temp11: () => import(/* webpackChunkName: "user-h5-min-sm" */ "./temp11.vue"),
    // 模板id=12
    temp12: () => import(/* webpackChunkName: "user-h5-min-sm" */ "./temp12.vue"),
    // 模板id=13
    temp13: () => import(/* webpackChunkName: "user-h5-min-sm" */ "./temp13.vue"),
    // 模板id=14
    temp14: () => import(/* webpackChunkName: "user-h5-min-sm" */ "./temp14.vue"),
    // 模板id=15
    temp15: () => import(/* webpackChunkName: "user-h5-min-sm" */ "./temp15.vue"),
    // 模板id=18
    temp18: () => import(/* webpackChunkName: "user-h5-min-sm" */ "./temp18.vue"),
    // 模板id=51
    temp51: () => import(/* webpackChunkName: "user-h5-min-sm" */ "./temp51.vue"),
  },
  // #TODO mixins
  // mixins: [betting],
  setup(props, evnet) {
