  ...
  <div class="chart basketball-chart">
    ...
    <div class="wrap-score basketball-score">
      ...
      <div class="score-item score-num-wrap first-item">
        ...
        <div class="score-tips">2 {{ i18n.t("common.score") }}</div>
        <!-- 客队2分次数 -->
      ...
      <div class="score-item score-num-wrap">
        ...
        <div class="score-tips">3 {{ i18n.t("common.score") }}</div>
        <!-- 客队3分次数 -->
        <div class="score-num match-away">
      ...
      <div class="score-item score-num-wrap">
        ...
        <div class="score-tips">{{ i18n.t("common.foul") }}</div>
      ...
      <div class="score-item last-item">
        <!-- 主队暂停 -->
        <div class="status-tips flex-3"> {{ i18n.t("basketball.pause") }} </div>
        <!-- 罚球 -->
        <div class="status-tips flex-4"> {{ i18n.t("basketball.penalty") }} </div>
         <!-- 客队暂停 -->
        <div class="status-tips flex-3"> &nbsp;{{ i18n.t("basketball.pause") }} </div>
      </div>
    </div>
