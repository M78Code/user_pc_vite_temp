  ...
  <div class="chart basketball-chart">
    ...
    <div class="wrap-score basketball-score">
      ...
      <div class="score-item score-num-wrap first-item">
        ...
        <div class="score-tips">2 {{ $root.$t("common.score") }}</div>
        <!-- 客队2分次数 -->
      ...
      <div class="score-item score-num-wrap">
        ...
        <div class="score-tips">3 {{ $root.$t("common.score") }}</div>
        <!-- 客队3分次数 -->
        <div class="score-num match-away">
      ...
      <div class="score-item score-num-wrap">
        ...
        <div class="score-tips">{{ $root.$t("common.foul") }}</div>
      ...
      <div class="score-item last-item">
        <!-- 主队暂停 -->
        <div class="status-tips flex-3"> {{ $root.$t("basketball.pause") }} </div>
        <!-- 罚球 -->
        <div class="status-tips flex-4"> {{ $root.$t("basketball.penalty") }} </div>
         <!-- 客队暂停 -->
        <div class="status-tips flex-3"> &nbsp;{{ $root.$t("basketball.pause") }} </div>
      </div>
    </div>
