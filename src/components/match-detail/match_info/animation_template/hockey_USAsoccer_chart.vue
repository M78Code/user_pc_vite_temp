    ...
    <div class="hockey_chart">
      <div class="wrap-up">
        <div class="round-item">
          ...
          <!-- 大罚 ：冲球数 -->
          <div class="text-c"> {{is_hockey?$root.$t('common.big_penalty'):$root.$t('common.rushing_num')}}</div>
        </div>
        ...
        <div class="round-item">
          ...
          <!-- 射门 -->
          <div class="text-c"> {{$root.$t('common.shot_num')}}</div>
        </div>
        ...
        <div class="round-item">
          ...
          <!-- 小罚：进攻数 -->
          <div class="text-c"> {{is_hockey?$root.$t('common.micro_penalty'):$root.$t('common.offense_num')}}</div>
        </div>
      </div>
      <!-- 达阵比分 -->
      <div class="wrap-down" v-if="!is_hockey">
        <!-- 达阵 -->
        <div class="text-c"> {{$root.$t('common.touchdown')}}</div>
        <div class="chart-bar">
