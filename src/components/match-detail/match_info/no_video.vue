  ...
  <div class="c-no-video yb-flex-center">
    <div class="no-video-inner">
      <div class="top-wrap">
        ...
        <!-- 暂无直播视频，请耐心等待 -->
        <div class="text1">{{$root.$t('video.novideo1')}}</div>
      </div>
      <div class="img-list">
        <div class="item">
          <div class="img img2"></div>
          <!-- 快速结算注单 -->
          <div class="text">{{$root.$t('video.novideo2')}}</div>
        </div>
        <div class="item">
          <div class="img img3"></div>
          <!-- 支持多种语言&货币 -->
          <div class="text" v-html="$root.$t('video.novideo3')"></div>
        </div>
        <div class="item">
          <div class="img img4"></div>
          <!-- 极致用户体验 -->
          <div class="text">{{$root.$t('video.novideo4')}}</div>
        </div>
        <div class="item">
          <div class="img img5"></div>
          <!-- 极致服务团队 -->
          <div class="text">{{$root.$t('video.novideo5')}}</div>
        </div>
      </div>
    </div>
  </div>
