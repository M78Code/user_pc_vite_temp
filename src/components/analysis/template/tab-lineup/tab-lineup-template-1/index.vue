  ...
  <div class="q-pb-md">
    ...
    <div class="lineup-wrap">
      ...
      <div class="lineup-item home">
        <div class="panel">
          <!-- 首发阵容 -->
          <div class="panel-title">{{ $root.$t('analysis.starting_lineup') }} {{ match.csid == '1' ? _.get(lineupData,
        ...
        <div class="panel">
          <!-- 替补阵容 -->
          <div class="panel-title">{{ $root.$t('analysis.bench_lineup') }} {{ match.csid == '1' ? _.get(lineupData,
            'home.homeFormation') : '' }}</div>
          <div class="d-table">
            <div class="d-table-h">
              <!-- 位置 -->
      ...
      <div class="lineup-item away">
        <div class="panel">
          <!-- 首发阵容 -->
          <div class="panel-title">{{ $root.$t('analysis.starting_lineup') }}
        ...
        <div class="panel">
          <!-- 替补阵容 -->
          <div class="panel-title">{{ $root.$t('analysis.bench_lineup') }}
            {{ match.csid == '1' ? _.get(lineupData, 'away.awayFormation') : '' }}</div>
          <div class="d-table">
            <div class="d-table-h">
              <!-- 位置 -->
