      ...
      <div class="bet-content">
        <div class="row">
          <div class="col bet-play-game">
            ...
            <label class="bet-play-text"><template v-if="market_type === 0"><label class="bet-match-playing">{{ $t('menu.match_playing')}}</label></template>{{play_name}}<template v-if="basic_score">({{basic_score}})</template><label class="bet-handicap-name">{{handicap_name}}</label></label>
          </div>
        </div>
        <!--队名及盘口区域-->
