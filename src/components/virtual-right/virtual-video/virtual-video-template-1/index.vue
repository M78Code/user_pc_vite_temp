      ...
      <div class="result-wrap fit" v-if="vsport_ctr.video_show_type == 'result'">
        <div class="yb-flex-center">
          <div class="result">
            ...
            <!-- 已完赛 -->
            <div class="yb-flex-center">
              <div class="end">{{ $t('list.match_end')}}</div>
            </div>
          </div>
        </div>
		    <!-- 期号时间 -->
...
.virtual-video {
  ...
  &.csid1001 {
    background-image: url("/yazhou-pc/image/common/virtual/bg1001.png");
  }
  &.csid1011 {
    background-image: url("/yazhou-pc/image/common/virtual/bg1011.png");
  }
  &.csid1002 {
    background-image: url("/yazhou-pc/image/common/virtual/bg1002.png");
  }
  &.csid1004 {
    background-image: url("/yazhou-pc/image/common/virtual/bg1004.png");
  }
  &.csid1010 {
    background-image: url("/yazhou-pc/image/common/virtual/bg1010.png");
  }
  &.csid1009 {
    background-image: url("/yazhou-pc/image/common/virtual/bg1009.png");
  }
  .video-wrap {
    .score-wrap {
      width: 225px;
      ...
      .live {
        width: 34px;
        height: 100%;
        background: url("/yazhou-pc/common/virtual/live_bai.svg") no-repeat;
