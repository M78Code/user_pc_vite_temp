        ...
        <div v-else class="f-b-s bet-content" :class="[
            ...
            <div class="fw-s-s bet-left">
                ...
                <div class="my-left">
                    ...
                    <div class="w-100 fon12 font400 my-4" v-if="items.home">{{ items.home }} <span class="mx-4">v</span> {{ items.away }} {{ items.matchType == 2? items.mark_score : ''}}
                    </div>
            ...
            <div class="fw-e-s bet-right" :class="{'width100': items.is_serial && !BetData.is_bet_single}" v-if="items.ol_os == 1 && items.hl_hs == 0 && items.mid_mhs == 0">
                ...
                <div v-if="items.red_green" :class="items.red_green" class="font12 bet-odds-change f-e-c">赔率已变更</div>
                <!-- 电子赛事不支持串关 -->
