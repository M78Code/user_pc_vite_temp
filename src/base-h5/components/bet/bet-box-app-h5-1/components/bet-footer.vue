...
<template>
   ...
   <div class="f-e-c bet-submit" v-if="BetViewDataClass.bet_order_status == 1">
        ...
        <div @click="set_bet_single" class="bet-single f-c-c font500 disabled" :class="{'disabled': MenuData.is_kemp(),'font16':BetData.is_bet_single,'font14':!BetData.is_bet_single, }">
...
const set_bet_single = () => {
  ...
  // alert(!this.BetData.is_bet_single)
