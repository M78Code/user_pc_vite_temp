...
import virtual_sports_tab from 'src/base-h5/pages/details/components/virtual_sports_tab.vue'
import virtual_sports_category from "src/base-h5/pages/details/children/virtual_sports_category.vue"
import virtual_match_statistic from 'src/base-h5/pages/details/components/virtual_match_statistic.vue'
