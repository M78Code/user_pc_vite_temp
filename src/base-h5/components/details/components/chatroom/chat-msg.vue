<!--
 * @FilePath: d:/projects/user-h5/src/base-h5/pages/details/components/chatroom/chat_msg.vue
 * @Description: 消息组件
-->
<template>
...
<script>
import bet_info from 'src/base-h5/pages/details/components/chatroom/bet_info.vue'; // 晒单展示组件
import { msgType } from 'src/base-h5/pages/details/components/chatroom/constant'; // 普通消息、注单消息
// #TODO vuex
