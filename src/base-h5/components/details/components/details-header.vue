...
import headerTop from "src/base-h5/pages/details/components/header/header-top.vue";   // 详情页视频区域中部(主副队logo+主副队名+赛事[阶段+时间+比分])
import headerBottom from "src/base-h5/pages/details/components/header/header-bottom.vue";   // 详情页视频区域(视频+动画按钮)+底部(赛事比分或者是足球犯规显示)
// import matchResultsHeader_top from "src/base-h5/pages/details/components/details-match-results/match-results-header-top.vue";  // 整个赛果详情页的上部比分
