...
import { itemSimpleBody, itemMultipleBody, earlySettle, cancelReserve, earlySettledDetail } from "src/base-h5/components/common/cathectic-item/app-h5/index";
...
const props = defineProps({
   ...
   * @returns {null} null
   */
// watch(() => BetRecordClass.selected, (_new) => {
//   console.log(_new);
// }, { immediate: true })
