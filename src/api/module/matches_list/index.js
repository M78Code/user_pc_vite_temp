...
//详情页获取玩法分类接口(新)
export const get_detail_category = (params, config={}, url = "/v1/w/category/getCategoryList") => http.get(`${prefix_11}${url}`, params);
...
//详情页获取玩法详情数据(新)
export const get_detail_data = (params, config={}, url = "/v1/w/matchDetail/getMatchDetailPB") => http.get(`${prefix_11}${url}`, params);
