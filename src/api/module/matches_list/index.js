 ...
 * @LastEditTime: 2023-11-07 21:24:07
...
//获取联赛数量统计(新)
export const get_leagues_list = (params, config={}, url = "/yewu11/v3/european/matchesByTid") => http.post(url, params);

//获取联赛数量统计
export const get_leagues_list_match = (params, config={}, url = "/yewu11/v3/european/getLeagues") => http.post(url, params);
