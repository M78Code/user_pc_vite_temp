 ...
 */
export const query_pre_bet_amount = (callback, type = '', oid = "") => {
  let bet_obj;
  //是单关
 ...
 * @return {undefined} undefined
 */
export const get_book_status_data = (params, callback) => {
 ...
 * @return {undefined} undefined
 */
export const cancel_book_record_order = (params, callback) => {
 ...
 * @return {undefined} undefined
 */
export const get_book_record_data = (params, callback) => {
