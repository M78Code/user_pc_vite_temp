 ...
 * @LastEditTime   : 2023-07-16 22:40:06
 * @FilePath       : \user-pc-vue3\src\public\utils\http\module\get_matches_list.js
...
// 实例化
const instance = new AxiosDebounceCache('get_matches_list');
// 开关
...
// 把参数传进来 核心参数拼接 ，注意需要自己去掉非 _ 下划线之外的特殊符号
  let str = `device_${params.device}_euid_${params.euid}_hasFlag_${params.hasFlag}_md_${params.md}_sort_${params.sort}_type_${params.type}`;
  return str
}
