 ...
 * @LastEditTime   : 2023-07-16 22:41:47
 * @FilePath       : \user-pc-vue3\src\public\utils\http\module\get_home_matches.js
...
// 实例化
const instance = new AxiosDebounceCache('get_home_matches');
// 开关
...
// 把参数传进来 核心参数拼接 ，注意需要自己去掉非 _ 下划线之外的特殊符号
  let str = `sort_${params.sort}_type_${params.type}`;
  return str
}
