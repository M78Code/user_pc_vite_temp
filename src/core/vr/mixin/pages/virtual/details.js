...
export const details_main = (router, route) => {
  let mid_ = route.params && route.params.mid || route.query.mid
  ...
  function getMatchDetailMatchInfo(params) {
    let obj_ = {
      ...
      fun_then: (res) => {
        ...
        // console.log("api_common.get_matchDetail_MatchInfo===", api_common.get_matchDetail_MatchInfo);
        console.log("res_data////ttt===", res);
