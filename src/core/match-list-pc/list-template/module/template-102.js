 ...
 export const template_102={
  main_handicap_list: [
    ...
    },
    {
      _hpid: 39,
      ols: [
        {  _hpid: 39, otb: '主队让分', ot: '1' },
        {  _hpid: 39, otb: '客队让分', ot: '2' },
      ],
    },
    {
      _hpid: 38,
      ols: [
        {  _hpid: 38, otb: '主队总分', ot: 'Over' },
        {  _hpid: 38, otb: '客队总分', ot: 'Under' },
      ],
    },
  ],
}
...
export const get_hots_odds_list = () => {
  let hots_odds_list = TemplateCommon.get_hots_odds_list(template_102.main_handicap_list)
