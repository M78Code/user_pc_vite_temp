...
export default class MatchListDataClass {
  ...
  */
  ...
  /**
   * @Description 设置联赛列表对象 赛事的详情页面 开赛、未赛
   * @param {object} league_list_obj
  */
  set_league_list_obj(league_list_obj){
    this.league_list_obj = league_list_obj
    // console.error(this.league_list_objj,'league_list_objleague_list_objleague_list_objleague_list_obj');
  }
  /**
