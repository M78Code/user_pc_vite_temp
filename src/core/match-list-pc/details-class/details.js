...
export default {
  ...
  */
  sr_click_handle(match) {
    ...
    if(!store.getters.get_global_switch.statistics_switch) return window.vue.useMittEmit(window.vue.MITT_TYPES.EMIT_SHOW_TOAST_CMD, window.vue.$root.$t("msg.msg_09")); 
