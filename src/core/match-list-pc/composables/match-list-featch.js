...
const vx_match_sort = ref(lodash.get(state,"filterReducer.show_filter_popup"));
// 是否展开多列玩法
const get_unfold_multi_column = ref(lodash.get(state,"filterReducer.show_filter_popup"));
