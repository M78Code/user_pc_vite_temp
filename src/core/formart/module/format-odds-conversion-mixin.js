...
export default {
  ...
  computed: {
    ...
    odds_constant() {
      ...
      // 印尼赔率  6
      return [{
          label: this.$root.$t('odds.EU'),
          value: "EU",
          icon: 'panda-icon-contryEU',
          id: 1
        }, //欧洲盘
        {
          label: this.$root.$t('odds.ID'),
          value: "ID",
          icon: 'panda-icon-contryYN',
          id: 6
        }, //印尼盘
        {
          label: this.$root.$t('odds.US'),
          value: "US",
          icon: 'panda-icon-contryUS',
          id: 5
        }, //美式盘
        {
          label: this.$root.$t('odds.MY'),
          value: "MY",
          icon: 'panda-icon-contryML',
          id: 3
        }, //马来盘
        {
          label: this.$root.$t('odds.GB'),
          value: "GB",
          icon: 'panda-icon-contryUK',
          id: 4
        }, //英式盘
        {
          label: this.$root.$t('odds.HK'),
          value: "HK",
