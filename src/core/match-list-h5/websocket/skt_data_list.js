...
// export const use_websocket_store = () => {
...
//   onMounted(() => {
//     ws_debounce.value = new ws_debounce(this, this.get_match_info_upd)
...
export default {
  ...
  methods: {
    ...
    RCMD_C302(obj) {
      ...
      clearTimeout(c302_timeout.value);
      //新开赛事后需要重新订阅C8
      c302_timeout.value = setTimeout(() => {
