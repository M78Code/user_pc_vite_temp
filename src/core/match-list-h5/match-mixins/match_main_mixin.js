...
import {
  ...
  get_virtual_result,
  get_tournament_list_v3
} from "src/project/api/module/common/index.js";
import { api_common } from "src/project/api/index.js";  // API 公共入口
    ...
    get_match_dom_show_property(i){
      ...
      let show_sport_type = i => {
        ...
        if ([1, 2, 3, 4, 11, 12,28, 30, 3000].includes(+this.menu_type) ||
            (_.get(this.get_current_menu, 'main') == 28 && _.get(this.get_current_menu, 'sub.menuType') == 29) ) {
          if (i > 0) {
