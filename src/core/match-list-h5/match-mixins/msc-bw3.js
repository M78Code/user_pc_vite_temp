...
export default {
  ...
  methods: {
    ...
    foot_basket_ball(match){
      if(match.msc && match.msc.length){
        ...
        if(match.csid == 1 || match.csid == 11){
          ...
          if(_.get(this.get_current_menu, 'main') == 28){ //赛果只显示S1 单号8410
            split = 'S1|';
          }
        }
     ...
     * @return {Object}
     */
    basket_ball_score_handle(match){
     ...
     * @return {Object}
     */
    us_football_score_handle(match){
