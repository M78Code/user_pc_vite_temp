    ...
    <div class="virtual-content-wrapper">
      <div class="virtual-sports-top">
        ...
        <div v-if="current_match.csid">
          ...
          <virtual-sports-right v-if="sub_menu_type && current_match" :current_match="current_match" :match_list_by_no="match_list_by_no" :switch_match_handle="switch_match_handle" />
        </div>
