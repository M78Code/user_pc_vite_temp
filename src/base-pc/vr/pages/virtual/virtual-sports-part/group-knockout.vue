...
import group_matches from "src/base-pc/vr/pages/virtual/virtual-sports-part/group-matches.vue";
import knockout from "src/base-pc/vr/pages/virtual/virtual-sports-part/knockout.vue";
export default {
