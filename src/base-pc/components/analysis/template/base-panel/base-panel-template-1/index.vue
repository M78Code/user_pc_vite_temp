...
import { formatTime, result_filter } from 'src/core/format/common/index.js'
...
<style lang="scss" scoped>@import url('./index.scss');</style>src/core/format/common/index.js