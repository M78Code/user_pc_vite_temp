...
.drag-scroll {
  ...
  .more-btn {
    ...
    height: 100%;
    top: 0;
    // background-image: url("/image/yabo/svg/list_filter_arrow_right.svg");
    ...
    &.left {
      ...
      background-image: url("/image/yabo/svg/video-swipe-arrow-left.svg");
    }
    &.right {
      right: -36px;
      background-image: url("/image/yabo/svg/video-swipe-arrow-right.svg");
    }
  }
}
</style>
