  ...
  <div class="football-after" v-if="isRouterAlive">
    <div class="info-time">
      ...
      <div class="time-node">
        ...
        <!-- 加时赛进球 -->
        <div class="result-icon-wrap" v-show="lodash.get(match_info, 'msc.S7')">
          <q-tooltip
            anchor="top middle"
            self="center middle"
            :content-style="tooltip_style"
        ...
        <div class="result-icon-wrap" v-show="lodash.get(match_info, 'msc.S170')">
          <q-tooltip
            anchor="top middle"
            self="center middle"
            :content-style="tooltip_style"
    ...
    <div class="info-both">
      ...
      <div class="both-away">
        <div class="wrap-logo">
          ...
          <!-- 红牌动画 -->
          <img class="red-flash" :class="{active:is_show_away_red}" style="margin-left:5px" :src="rs_hong">
        </div>
        <div class="info-data">
          <!-- 角球总比分 -->
...
import rs_hong from 'project_path/image/svg/rs_hong.svg'
