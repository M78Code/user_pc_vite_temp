...
let {BUILD_VERSION ,PROJECT_NAME ,BUILD_DIR_NAME ,BUILD_OUTDIR ,IS_TOPIC_PROJECT} = BUILD_VERSION_CONFIG;
...
if(IS_TOPIC_PROJECT){
    fs.writeFileSync( `./dist/${BUILD_DIR_NAME}/${BUILD_DIR_NAME}/index.html`,html_file)
}else{
