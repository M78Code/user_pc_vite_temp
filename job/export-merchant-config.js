...
// const SERVER_CONFIG_FILE_PATH = `http://assets-image.oceasfe.com/public/upload/json/20230903/project_4-36304ea0499e11ee8848ada2b8a1d739-1693720827442-shiwan-1.json`;
const SERVER_CONFIG_FILE_PATH = `http://assets-image.oceasfe.com/public/upload/json/${get_date_format()}/${BUILD_VERSION_CONFIG.MODULE_SDK_VERSION}-1.json`;
