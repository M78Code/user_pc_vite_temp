...
try {
    DEV_TARGET_ENV_CONFIG = await import( "../../dev-target-env.js.js"  );
} catch (error) {
}
const {DEV_TARGET_ENV} = DEV_TARGET_ENV_CONFIG
import {  write_file } from "../write-folder-file.jss";
...
//主题项目构建类型标识
const TOPIC_PROJECT_BUILD_TYPE_KEY ="TOPIC_PROJECT_BUILD_TYPE_10"
//构建版本基础参数
